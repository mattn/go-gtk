...
install:
	...
	cd gtk/gtksourceview && gomake install
...
clean:
	...
	cd gtk && gomake clean
	cd gtk/gtksourceview && gomake clean
	cd example && gomake clean

fmt_all:
	gofmt ./gdk/gdk.go  > ./gdk/gdk.go.fmt
	gofmt ./gtk/gtk.go > ./gtk/gtk.go.fmt
	gofmt ./gtk/gtksourceview/gtksourceview.go > ./gtk/gtksourceview/gtksourceview.go.fmt
	...
	mv ./gtk/gtksourceview/gtksourceview.go.fmt ./gtk/gtksourceview/gtksourceview.go
